<template>
  <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4 border-b border-slate-100">
      <h2 class="font-semibold text-slate-800">Canales Principales</h2>
    </header>
    <div class="grow p-3">
      <div class="flex flex-col h-full">
        ...
        <div class="text-center pt-4 pb-1 border-t border-slate-100">
          <router-link class="text-sm font-medium text-indigo-500 hover:text-indigo-600" to="#0">Reporte de Canales -&gt;</router-link>
        </div>
      </div>
    </div>
  </div>
