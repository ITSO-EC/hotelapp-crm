<template>
  <div class="relative">
    ...
    >
      ...
      <div class="truncate">
        <span class="text-sm font-medium">{{companyOne}}</span>
      </div>
            ...
            <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  ...
                  <div class="truncate">{{companyOne}}</div>
                </div>
            ...
            <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  ...
                  <div class="truncate">{{companyOne}} Limited</div>
                </div>
              </div>
            </a>
          </li>
            ...
            <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
              <div class="flex items-center justify-between">
                <div class="grow flex items-center truncate">
                  ...
                  <div class="truncate">{{companyOne}} Srl</div>
                </div>
              </div>
            </a>
          </li>
