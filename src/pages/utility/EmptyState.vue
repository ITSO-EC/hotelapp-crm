        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
              <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Vista Vacía</h1>
            </div>
          ...
          <div class="border-t border-slate-200">
            <div class="max-w-2xl m-auto mt-16">
              ...
              <div class="text-center px-4">
                ...
                <h2 class="text-2xl text-slate-800 font-bold mb-2">¿Que emocionantes aventuras vas a crear ahora?</h2>
                <div class="mb-6">Dale click al botón para comenzar a crear categorías.</div>
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                  <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                  </svg>
                  <span class="ml-2">Crear Categorías</span>
                </button>
              </div>
