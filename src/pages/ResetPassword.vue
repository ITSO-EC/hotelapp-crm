      ...
      <div class="w-full md:w-1/2">
        <div class="min-h-screen h-full flex flex-col after:flex-1">
          ...
          <div class="max-w-sm mx-auto px-4 py-8">
            <h1 class="text-3xl text-slate-800 font-bold mb-6">Recupere su cuenta🔍</h1>
            <!-- Form -->
            <form>
              <div class="space-y-4">
                <div>
              ...
              <div class="flex justify-end mt-6">
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap">Enviar Link</button>
              </div>
            </form>
          </div>
